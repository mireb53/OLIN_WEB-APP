...
<tr class="hover:bg-gray-50 transition-colors duration-150" data-course-id="{{ $c->id }}" data-program-id="{{ $c->program_id ?? '' }}" data-status="{{ $c->status }}">
  ...
  <a href="{{ route('admin.courseManagement.details', $c) }}" data-id="{{ $c->id }}" class="js-view-inline inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-700 hover:bg-slate-200 hover:border-slate-300 transition-all duration-150 text-xs font-medium">
