...
<div class="bg-white rounded-xl shadow p-6 space-y-8">
    ...
    <div class="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div class="flex flex-col items-center gap-3">
            ...
            @else
                <div class="w-28 h-28 rounded-full bg-green-600 text-white flex items-center justify-center text-3xl font-bold shadow">
    ...
    <!-- Stats Section (3 horizontal cards) -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-green-50 border border-green-200 rounded-xl p-6 shadow-sm text-center">
            <div class="text-sm font-medium text-green-700">Enrolled Courses</div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 shadow-sm text-center">
            <div class="text-sm font-medium text-blue-700">Status</div>
