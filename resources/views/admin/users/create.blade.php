<x-layoutAdmin>
    <main class="flex-1 p-6">
        ...
        <div class="page-header">
            ...
            <p class="page-description">Add a new user to the OLIN system</p>
        </div>

        <form method="POST" action="{{ route('admin.users.store') }}" class="bg-white rounded-md shadow-sm p-6 mb-6">
            @csrf
            ...
            <div class="border-t border-gray-200 mt-6 pt-6">
                <h3 class="text-lg font-medium mb-4">Set Password</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-group">
